...
<nav class="bg-indigo-600 border-t border-gray-200 w-full max-w-sm mx-auto fixed bottom-0 left-0 right-0">
    <div class="flex justify-around text-sm text-white">
        ...
        <a href="{{ route('dashboard.superadmin') }}"
           class="flex flex-col items-center py-2 {{ Request::routeIs('dashboard.superadmin') ? 'text-white' : 'text-indigo-200' }}">
        ...
        <a href="{{ route('admin.user.index') }}"
           class="flex flex-col items-center py-2 {{ Request::routeIs('admin.user.index') ? 'text-white' : 'text-indigo-200' }}">
        ...
        <a href="{{ route('admin.announcement.index') }}"
           class="flex flex-col items-center py-2 {{ Request::routeIs('admin.announcement.index') ? 'text-white' : 'text-indigo-200' }}">
